...
#********************************************************************************************************************\
# 
#   File Name  :   Dhanush_buildscript_Advanced_manual.pl
#    
...
if($num_args < 4)
{ 
	print "Usage: perl Dhanush_buildscript_Advanced_manual.pl <1-8> <Daily/Release> <Trunk/Branch Repository name> <local path(Folder name where trunk or release codes will check out)>\n";
	...
	if((-f "$local_path_sourcecode_kernel/arch/mips/boot/vmlinux.bin"))
	{
		...
		if($build ne "All")
		{
			if(-f "$local_path/images_up.tar.gz")
			{
				...
				fcopy("$local_path_sourcecode_kernel/arch/mips/boot/vmlinux.bin", "$local_path/images/boot");

				fcopy("$local_path_sourcecode_kernel/drivers/net/wireless/ti/wlcore/wlcore.ko","$local_path/images/modules");

				fcopy("$local_path_sourcecode_kernel/drivers/net/wireless/ti/wlcore/wlcore_sdio.ko","$local_path/images/modules");

				fcopy("$local_path_sourcecode_kernel/drivers/net/wireless/ti/wl12xx/wl12xx.ko","$local_path/images/modules");

				fcopy("$local_path_sourcecode_kernel/drivers/misc/ti-st/tty_hci.ko","$local_path/images/modules");

				fcopy("$local_path_sourcecode_kernel/drivers/misc/ti-st/st_drv.ko","$local_path/images/modules");
				...
				elsif($subject eq "Daily")
				{
					...
					#remove images_$currentTime.tar.gz
...
if($build eq "All")
{
	...
	$body = "$start_body$img_body$aon_msg$native_msg$kernel_msg$bl1_msg$uboot_msg$bl0_msg$dfu_msg$bl1_sd_msg$loadspi_msg$android_msg$end_body";
