...
#********************************************************************************************************************\
# 
#   File Name  :   Dhanush_buildscript_Arjuna_manual.pl
#    
...
if($num_args < 4)
{ 
	print "Usage: perl Dhanush_buildscript_Arjuna_manual.pl <1-7> <Daily/Release> <Trunk/Branch Repository name> <local path(Folder name where trunk or release codes will check out)>\n";
...
if($input eq 1)
{
	print "Building Dhanushkernel, DhanushAndroid, DhanushAON, DhanushBL1, DhanushUboot, DhanushBL0...\n";
	$build = "All";
}
elsif($input eq 2)
{
...
{
	print "Please Pass the arguments (1-7)";
	exit;
}
...
#To continue release numbers reading release number from local file
	open(my $RF, "</home/$username/release_arjuna.txt") || die("Can't open file: /home/$username/release_arjuna.txt");
	@txt = <$RF>;
	...
	$rel_number = $txt_read;
	$sub_rel = "00.92.$rel_number";
	close($RF);
	$buildnumber="00.92.$rel_number";
}
else
{
...
if($ARGV[1] eq "Daily")
{
	$dst_images_dir = "/home/$username/share/Arjuna_Builds/Daily_images/$currentDate";
	$dst_images_dir1 = "//192.168.42.46/share/Arjuna_Builds/Daily_images/$currentDate";
}
elsif($ARGV[1] eq "Release")
{
	$dst_images_dir = "/home/$username/share/Arjuna_Builds/Release_images/$currentDate";
	$dst_images_dir1 = "//192.168.42.46/share/Arjuna_Builds/Release_images/$currentDate";
	$buildnumber="$buildnumber\_$currentDate";
}

$share_path = "/home/$username/share/Arjuna_Builds";
...
$sourcecode_repo_path_scripts="http://insvn01:9090/svn/swdepot/Dhanush/Tools/Scripts";
...
fcopy("$dhanushandroid_path/Android/adv_fullbuild.sh", "$dhanushandroid_path/adv_fullbuild.sh");
...
if(($build eq "DhanushKernel") || ($build eq "All"))
{
	...
	$dst_reports_log_dir_Android="/home/$username/share/Arjuna_error_logs/Dhanush-Android/$currentDate/$currentTime";
	$dst_reports_log_dir_Android1="//192.168.42.46/share/Arjuna_error_logs/Dhanush-Android/$currentDate/$currentTime";
	...
	#function to check the revision and check out
	$message = "Asthra Agni Kernel Source";
	...
	$status=system("./build.sh up clean no a2a > kernel_buildlog.txt 2> kernel_faillog.txt");
	...
	if((-f "$local_path_sourcecode_kernel/arch/mips/boot/vmlinux.bin"))
	{
		...
		{
			$dst_reports_dir_Android="/home/$username/share/Arjuna_Builds/Release_Builds/$buildnumber/$currentTime/Kernel_$repo_print";
			$dst_reports_dir_Android1="//192.168.42.46/share/Arjuna_Builds/Release_Builds/$buildnumber/$currentTime/Kernel_$repo_print";
		}
	
		elsif($subject eq "Daily")
		{
			$dst_reports_dir_Android="/home/$username/share/Arjuna_Builds/Daily_Builds/$currentDate/$currentTime/Kernel_$repo_print";
			$dst_reports_dir_Android1="//192.168.42.46/share/Arjuna_Builds/Daily_Builds/$currentDate/$currentTime/Kernel_$repo_print";
		}
		...
		if($return_value=mailstatus("Buildpass"))
		{
			if($build ne "All")
			{
				if(($subject eq "Weekly") || ($subject eq "Release"))
				{
					$subject1 = "Asthra Agni Android Kernel Build - $sub_rel";
				}
				elsif($subject eq "Daily")
				{
					$subject1 = "Asthra Agni Android Kernel Build";
				}
			...
			if($build eq "All")
			{
				$kernel_msg = "\n\n\nAndroid Kernel:\nAsthra Agni Android Kernel Build Completed Successfully for the svn check-in at $sourcecode_repo_path_kernel with revision: $repo_print.\nPlease find the output binaries in the share path: \"$dst_reports_dir_Android1\".";
			}
		}
	}
	else
	{
		...
		{	
			if(($subject eq "Weekly") || ($subject eq "Release"))
			{
				$subject1 = "Android Kernel Build Failed - $sub_rel";
			}
			elsif($subject eq "Daily")
			{
				$subject1 = "Android Kernel Build Failed";
			}

			sendMail($Dev_team, $subject1, $body, "");
			if($build eq "All")
			{
				$kernel_msg = "\n\n\nAndroid Kernel:\nAndroid Kernel Build Failed, mail has been send previously on build failed sharing the information of error logs path for SVN check-in at $sourcecode_repo_path_kernel with revision:$repo_print.";
			}
		}
	}
}
...
if(($build eq "DhanushAndroid") || ($build eq "All") || ($build eq "DhanushKernel"))
{
	...
	#function to check the revision and check out
	$message = "Asthra Agni Android Kitkat Source";
...
REPEAT_BUILD:
	...
	$status=system("./adv2_fullbuild.sh $arg no $arg3 a2a > Android_buildlog.txt 2> Android_faillog.txt");
	...
	if((!(-f "$local_path_sourcecode_kitkat/images/rfs/system.img")) || ($status)) 
	{
		...
		{	
			...
			if(($subject eq "Weekly") || ($subject eq "Release"))
			{
				$subject1 = "Asthra Agni Android FS(Kitkat) $arg3 Build Failed - $sub_rel";
			}
			elsif($subject eq "Daily")
			{
				$subject1 = "Asthra Agni Android FS(Kitkat) $arg3 Build Failed";
			}
	...
	else
	{
		...
		if(($subject eq "Weekly") || ($subject eq "Release"))
		{	
			$dst_reports_dir_Android="/home/$username/share/Arjuna_Builds/Release_Builds/$buildnumber/$currentTime/AndroidFS_$repo_print";
			$dst_reports_dir_Android1="//192.168.42.46/share/Arjuna_Builds/Release_Builds/$buildnumber/$currentTime/AndroidFS_$repo_print";
		}
	
		elsif($subject eq "Daily")
		{
			$dst_reports_dir_Android="/home/$username/share/Arjuna_Builds/Daily_Builds/$currentDate/$currentTime/AndroidFS_$repo_print";
			$dst_reports_dir_Android1="//192.168.42.46/share/Arjuna_Builds/Daily_Builds/$currentDate/$currentTime/AndroidFS_$repo_print";
		}
		...
		fcopy("$local_path_sourcecode_kernel/arch/mips/boot/vmlinux.bin", "$local_path_sourcecode_kitkat/images/boot");

		fcopy("$local_path_sourcecode_kernel/drivers/net/wireless/ti/wlcore/wlcore.ko","$local_path_sourcecode_kitkat/images/modules");

		fcopy("$local_path_sourcecode_kernel/drivers/net/wireless/ti/wlcore/wlcore_sdio.ko","$local_path_sourcecode_kitkat/images/modules");

		fcopy("$local_path_sourcecode_kernel/drivers/net/wireless/ti/wl12xx/wl12xx.ko","$local_path_sourcecode_kitkat/images/modules");

		fcopy("$local_path_sourcecode_kernel/drivers/misc/ti-st/tty_hci.ko","$local_path_sourcecode_kitkat/images/modules");

		fcopy("$local_path_sourcecode_kernel/drivers/misc/ti-st/st_drv.ko","$local_path_sourcecode_kitkat/images/modules");


		fcopy("$local_path_sourcecode_SGX/eurasia_km/eurasiacon/binary2_incdhad1_android_release/target/dc_incdhad1.ko","$local_path_sourcecode_kitkat/images/modules");

		fcopy("$local_path_sourcecode_SGX/eurasia_km/eurasiacon/binary2_incdhad1_android_release/target/pvrsrvkm.ko","$local_path_sourcecode_kitkat/images/modules");

		fcopy("$local_path_sourcecode_kitkat/hardware/img/combined_source/imgvideo/imgvideo.ko","$local_path_sourcecode_kitkat/images/modules");

		fcopy("$local_path_sourcecode_kitkat/hardware/img/combined_source/vdec/vdecdd.ko","$local_path_sourcecode_kitkat/images/modules");
		...
		fcopy("$local_path/images_$arg3.tar.gz", $dst_reports_dir_Android);
		...
		{	
			...
			if($build ne "All")
			{
				if(($subject eq "Weekly") || ($subject eq "Release"))
				{
					$subject1 = "Asthra Agni Android FS(Kitkat) Build - $sub_rel";
				}
				elsif($subject eq "Daily")
				{
					$subject1 = "Asthra Agni Android FS(Kitkat) Build";
				}
				sendMail($Dev_team, $subject1, $body, "");
			}
			if($build eq "All")
			{
				$android_msg = "\n\n\nAndroid FS(Kitkat):\nAsthra Agni Android FS(Kitkat) Build Completed Successfully for the svn check-in at $sourcecode_repo_path_kitkat with revision: $repo_print.\nPlease find the output binaries in the share path: \"$dst_reports_dir_Android1\".";
			}
		}
	}
}
...
if(($build eq "DhanushAON") || ($build eq "All"))
{
	...
	#declaration of destination directories
	$dst_reports_log_dir_AON="/home/$username/share/Arjuna_error_logs/DhanushAON/$currentDate/$currentTime";
	$dst_reports_log_dir_AON1="//192.168.42.46/share/Arjuna_error_logs/DhanushAON/$currentDate/$currentTime";
	...
	$message = "Asthra Agni AON Source";
	...
	if((!(-f "$dhanushaon_path/output/aon.bin") || !(-f "$dhanushaon_path/output/dfu.bin") ) || ($status)) 
	{
		...
		$body = "Hi Team,\n\n\nFailures observed while building the Asthra Agni AON code for the svn check-in at $sourcecode_repo_path with revision:$repo_print.\nPlease find the build log in the share path:\"$dst_reports_log_dir_AON1\".	\n\n\n\n****This is an Automatically generated email notification from Build server****";

		if($return_value=mailstatus("Buildfail"))
		{
			if(($subject eq "Weekly") || ($subject eq "Release"))
			{
				$subject1 = "Asthra Agni AONSensor Build Failed - $sub_rel";
			}
			elsif($subject eq "Daily")
			{
				$subject1 = "Asthra Agni AONSensor Build Failed";
			}
	...
	else
	{
		...
		if(($subject eq "Weekly") || ($subject eq "Release"))
		{		
			$dst_reports_dir_AON="/home/$username/share/Arjuna_Builds/Release_Builds/$buildnumber/$currentTime/AON_$repo_print";
			$dst_reports_dir_AON1="//192.168.42.46/share/Arjuna_Builds/Release_Builds/$buildnumber/$currentTime/AON_$repo_print";
		}
		elsif($subject eq "Daily")
		{
			$dst_reports_dir_AON="/home/$username/share/Arjuna_Builds/Daily_Builds/$currentDate/$currentTime/AON_$repo_print";
			$dst_reports_dir_AON1="//192.168.42.46/share/Arjuna_Builds/Daily_Builds/$currentDate/$currentTime/AON_$repo_print";
		}
		...
		$body = "Hi Team,\n\n\nAsthra Agni AON Build Completed Successfully for the svn check-in at $sourcecode_repo_path with revision: $repo_print. \nPlease find the output binaries in the share path: \"$dst_reports_dir_AON1\".\n\n\n\n****This is an Automatically generated email notification from Build server****";
...
if(($build eq "DhanushBL1") || ($build eq "All"))
{
	...
	#Declaration of destination directories
	$dst_reports_log_dir_BL1="/home/$username/share/Arjuna_error_logs/Dhanush-BL1/$currentDate/$currentTime";
	$dst_reports_log_dir_BL11="//192.168.42.46/share/Arjuna_error_logs/Dhanush-BL1/$currentDate/$currentTime";
	...
	#function to check the revision and check out
	$message = "Asthra Agni BL1 Source";
	...
	if((!(-f "$dhanushBL1_path/out/bl1.bin")) || ($status)) 
	{
		...
		if($return_value=mailstatus("Buildfail"))
		{
			if(($subject eq "Weekly") || ($subject eq "Release"))
			{
				$subject1 = "Asthra Agni BL1 Build Failed - $sub_rel";
			}
			elsif($subject eq "Daily")
			{
				$subject1 = "Asthra Agni BL1 Build Failed";
			}
	...
	else
	{
		...
		if(($subject eq "Weekly") || ($subject eq "Release"))
		{
			$dst_reports_dir_BL1="/home/$username/share/Arjuna_Builds/Release_Builds/$buildnumber/$currentTime/BL1_$repo_print";
			$dst_reports_dir_BL11="//192.168.42.46/share/Arjuna_Builds/Release_Builds/$buildnumber/$currentTime/BL1_$repo_print";
		}
	
		elsif($subject eq "Daily")
		{
			$dst_reports_dir_BL1="/home/$username/share/Arjuna_Builds/Daily_Builds/$currentDate/$currentTime/BL1_$repo_print";
			$dst_reports_dir_BL11="//192.168.42.46/share/Arjuna_Builds/Daily_Builds/$currentDate/$currentTime/BL1_$repo_print";
		}
		...
		{	
			if($build ne "All")
			{
				if(($subject eq "Weekly") || ($subject eq "Release"))
				{
					$subject1 = "Asthra Agni BL1 Build - $sub_rel";
				}
				elsif($subject eq "Daily")
				{
					$subject1 = "Asthra Agni BL1 Build";
				}
...
if(($build eq "DhanushUboot") || ($build eq "All"))
{
	...
	#Declaration of destination directories
	$dst_reports_log_dir_Uboot="/home/$username/share/Arjuna_error_logs/U-Boot/$currentDate/$currentTime";
	$dst_reports_log_dir_Uboot1="//192.168.42.46/share/Arjuna_error_logs/U-Boot/$currentDate/$currentTime";
	...
	#function to check the revision and check out
	$message = "Asthra Agni Uboot Source";
	...
	if((!(-f "$dhanushUboot_path/u-boot.bin")) || ($status))
	{
		...
		if($return_value=mailstatus("Buildfail"))
		{
			if(($subject eq "Weekly") || ($subject eq "Release"))
			{
				$subject1 = "Asthra Agni U-Boot Build Failed - $sub_rel";
			}
			elsif($subject eq "Daily")
			{
				$subject1 = "Asthra Agni U-Boot Build Failed";
			}
	...
	else
	{
		...
		if(($subject eq "Weekly") || ($subject eq "Release"))
		{
			$dst_reports_dir_Uboot="/home/$username/share/Arjuna_Builds/Release_Builds/$buildnumber/$currentTime/U-Boot_$repo_print";
			$dst_reports_dir_Uboot1="//192.168.42.46/share/Arjuna_Builds/Release_Builds/$buildnumber/$currentTime/U-Boot_$repo_print";
		}
	
		elsif($subject eq "Daily")
		{
			$dst_reports_dir_Uboot="/home/$username/share/Arjuna_Builds/Daily_Builds/$currentDate/$currentTime/U-Boot_$repo_print";
			$dst_reports_dir_Uboot1="//192.168.42.46/share/Arjuna_Builds/Daily_Builds/$currentDate/$currentTime/U-Boot_$repo_print";
		}
		...
		if($return_value=mailstatus("Buildpass"))
		{
			if($build ne "All")
			{
				if(($subject eq "Weekly") || ($subject eq "Release"))
				{
					$subject1 = "Asthra Agni U-Boot Build - $sub_rel";
				}
				elsif($subject eq "Daily")
				{
					$subject1 = "Asthra Agni U-Boot Build";
				}
...
if(($build eq "DhanushBL0") || ($build eq "All"))
{
	...
	#Declaration of destination directories
	$dst_reports_log_dir_BL0="/home/$username/share/Arjuna_error_logs/Dhanush-BL0/$currentDate/$currentTime";
	$dst_reports_log_dir_BL01="//192.168.42.46/share/Arjuna_error_logs/Dhanush-BL0/$currentDate/$currentTime";
	...
	#function to check the revision and check out
	$message = "Asthra Agni BL0 Source";
	...
	if((!(-f "$dhanushBL0_path/bin/bl0.bin")) || ($status)) 
	{
		...
		if($return_value=mailstatus("Buildfail"))
		{
			if(($subject eq "Weekly") || ($subject eq "Release"))
			{
				$subject1 = "Asthra Agni BL0 Build Failed - $sub_rel";
			}
			elsif($subject eq "Daily")
			{
				$subject1 = "Asthra Agni BL0 Build Failed";
			}
	...
	else
	{
		...
		if(($subject eq "Weekly") || ($subject eq "Release"))
		{
			$dst_reports_dir_BL0="/home/$username/share/Arjuna_Builds/Release_Builds/$buildnumber/$currentTime/BL0_$repo_print";
			$dst_reports_dir_BL01="//192.168.42.46/share/Arjuna_Builds/Release_Builds/$buildnumber/$currentTime/BL0_$repo_print";
		}
	
		elsif($subject eq "Daily")
		{
			$dst_reports_dir_BL0="/home/$username/share/Arjuna_Builds/Daily_Builds/$currentDate/$currentTime/BL0_$repo_print";
			$dst_reports_dir_BL01="//192.168.42.46/share/Arjuna_Builds/Daily_Builds/$currentDate/$currentTime/BL0_$repo_print";
		}
		...
		{	
			if($build ne "All")
			{
				if(($subject eq "Weekly") || ($subject eq "Release"))
				{
					$subject1 = "Asthra Agni BL0 Build - $sub_rel";
				}
				elsif($subject eq "Daily")
				{
					$subject1 = "Asthra Agni BL0 Build";
				}
...
if($build eq "All")
{
	...
	$body = "$start_body$img_body$aon_msg$kernel_msg$bl1_msg$uboot_msg$bl0_msg$dfu_msg$loadspi_msg$android_msg$end_body";

	if(($subject eq "Weekly") || ($subject eq "Release"))
	{
		$subject1 = "Asthra Agni $subject Builds - $sub_rel";
	}
	elsif($subject eq "Daily")
	{
		$subject1 = "Asthra Agni $subject Builds";
	}
...
sub change_envfile_path
{
	...
	my $str = "export AON_SUPPORT_FOR_ANDROID_WEARBLE=";
	my $str_replace = "=1";
