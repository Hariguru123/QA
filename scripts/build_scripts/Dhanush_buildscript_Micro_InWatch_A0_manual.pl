...
#********************************************************************************************************************************
# 
#   File Name  :   Dhanush_buildscript_Micro_InWatch_A0_manual.pl
#    
...
if($num_args < 4)
{ 
	print "Usage: perl Dhanush_buildscript_Micro_InWatch_A0_manual.pl <1-4> <Daily/Release> <Trunk/Branch Repository name> <local path(Folder name where trunk or release codes will check out)>\n";
