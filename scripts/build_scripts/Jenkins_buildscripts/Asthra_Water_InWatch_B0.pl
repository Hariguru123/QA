...
#********************************************************************************************************************************
# 
#   File Name  :   Asthra_Water_InWatch_B0.pl
#    
#   Description:  It builds the Dhanush Micro InWatch_B0 code, when AONsensor, Native and Bootloader codes are available.
#	  
#********************************************************************************************************************************

use File::Copy::Recursive qw(fcopy rcopy dircopy fmove rmove dirmove);

print "Building InWatch_B0 - DhanushAON Micro, DhanushBootLoader Micro, DhanushNative Micro Projects.....";

#Declaration of local path
$username="socplatform-qa";
$local_path="/media/Data/Jenkins/InWatch_B0";
$subject = "Daily";
...
if($subject eq "Daily")
{
	$dst_images_dir = "/home/$username/share/Micro_InWatch_B0_Builds/Daily_images/$currentDate";
	$dst_images_dir1 = "//192.168.42.46/share/Micro_InWatch_B0_Builds/Daily_images/$currentDate";
}
elsif($subject eq "Release")
{
	$dst_images_dir = "/home/$username/share/Micro_InWatch_B0_Builds/Release_images/$currentDate";
	$dst_images_dir1 = "//192.168.42.46/share/Micro_InWatch_B0_Builds/Release_images/$currentDate";
...
$dst_reports_log_dir_AON="/home/$username/share/Micro_InWatch_B0_error_logs/DhanushAON/$currentDate/$currentTime";
$dst_reports_log_dir_AON1="//192.168.42.46/share/Micro_InWatch_B0_error_logs/DhanushAON/$currentDate/$currentTime";

system("chmod -R 777 $dhanushaon_path/*");

print "*****************InWatch_B0 AONsensor BUILD PROCESS****************************\n";
...
{
	print "InWatch_B0 AONsensor Build completed successfully \n";

	#update the destination folder after successfull build

	if(($subject eq "Weekly") || ($subject eq "Release"))
	{		
		$dst_reports_dir_AON="/home/$username/share/Micro_InWatch_B0_Builds/Release_Builds/$buildnumber/$currentTime/AON";
		$dst_reports_dir_AON1="//192.168.42.46/share/Micro_InWatch_B0_Builds/Release_Builds/$buildnumber/$currentTime/AON";
	}
	elsif($subject eq "Daily")
	{
		$dst_reports_dir_AON="/home/$username/share/Micro_InWatch_B0_Builds/Daily_Builds/$currentDate/$currentTime/AON";
		$dst_reports_dir_AON1="//192.168.42.46/share/Micro_InWatch_B0_Builds/Daily_Builds/$currentDate/$currentTime/AON";
	}
...
$dhanushbl0_genbins_path="$dhanushbootldr_path/gen_bins.sh";
$dhanushbl0_genbins_temp_path="$dhanushbootldr_path/temp_gen_bins.sh";

#Declaration of destination directories
$dst_reports_log_dir_bootldr="/home/$username/share/Micro_InWatch_B0_error_logs/DhanushBootLoader/$currentDate/$currentTime";
$dst_reports_log_dir_bootldr1="//192.168.42.46/share/Micro_InWatch_B0_error_logs/DhanushBootLoader1/$currentDate/$currentTime";

print "*****************InWatch_B0 BootLoader BUILD PROCESS****************************\n";	
...
change_envfile_path($dhanushbootldr_path,$dhanushbl0_genbins_path,$dhanushbl0_genbins_temp_path);
...
{
	print("\n InWatch_B0 BootLoader Build Failed, Copying Build log in to share folder\n");
...
{
	print "InWatch_B0 BootLoader Build completed successfully \n";

	#update the destination folder after successfull build	
	if(($subject eq "Weekly") || ($subject eq "Release"))
	{
		$dst_reports_dir_bootldr="/home/$username/share/Micro_InWatch_B0_Builds/Release_Builds/$buildnumber/$currentTime/BootLoader";
		$dst_reports_dir_bootldr1="//192.168.42.46/share/Micro_InWatch_B0_Builds/Release_Builds/$buildnumber/$currentTime/BootLoader";
	}
	elsif($subject eq "Daily")
	{
		$dst_reports_dir_bootldr="/home/$username/share/Micro_InWatch_B0_Builds/Daily_Builds/$currentDate/$currentTime/BootLoader";
		$dst_reports_dir_bootldr1="//192.168.42.46/share/Micro_InWatch_B0_Builds/Daily_Builds/$currentDate/$currentTime/BootLoader";
	}
...
#Declaration of destination directories
$dst_reports_log_dir_Native="/home/$username/share/Micro_InWatch_B0_error_logs/DhanushNative/$currentDate/$currentTime";
$dst_reports_log_dir_Native1="//192.168.42.46/share/Micro_InWatch_B0_error_logs/DhanushNative/$currentDate/$currentTime";

print "*****************InWatch_B0 Native BUILD PROCESS****************************\n";	
...
{
	print "InWatch_B0 Native Build completed successfully \n";

	#update the destination folder after successfull build	
	if(($subject eq "Weekly") || ($subject eq "Release"))
	{
		$dst_reports_dir_Native="/home/$username/share/Micro_InWatch_B0_Builds/Release_Builds/$buildnumber/$currentTime/Native";
		$dst_reports_dir_Native1="//192.168.42.46/share/Micro_InWatch_B0_Builds/Release_Builds/$buildnumber/$currentTime/Native";
	}
	elsif($subject eq "Daily")
	{
		$dst_reports_dir_Native="/home/$username/share/Micro_InWatch_B0_Builds/Daily_Builds/$currentDate/$currentTime/Native";
		$dst_reports_dir_Native1="//192.168.42.46/share/Micro_InWatch_B0_Builds/Daily_Builds/$currentDate/$currentTime/Native";
	}
...
print "Dhanush Micro InWatch_B0 binaries are copied to $dst_images_dir \n";
...
sub change_envfile_path
{
	...
	my $src_string1 = "export B0_CHIP=";
	my $src_path1 = "=1";
	my $src_string2 = "export A0_CHIP=";
	my $src_path2 = "=0";
	my $src_string3 = "make A0=1 B0=0";
	my $src_path3 = "make A0=0 B0=1";
	...
	foreach my $line (<$RD>)
	{
		...
		elsif($line =~ /$src_string3/)
   		{
        		if($line=~s/$src_string3/$src_path3/)
        		{  
				print $RD1 $line;
			}	    
   		}
