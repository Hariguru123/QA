...
#********************************************************************************************************************\
# 
#   File Name  :   Asthra_Agni_buildscript.pl
#    
#   Description:  It builds the Asthra Agni(Advanced) build configuration when executed on jenkins. If build failed, old binaries will be packaged and shared.
#   	
# ********************************************************************************************************************/

use File::Copy::Recursive qw(fcopy rcopy dircopy fmove rmove dirmove);

print "Building Arjuna - DhanushAON, DhanushBL1, DhanushUboot, DhanushBL0, DhanushAndroid\n";

#Declaration of local path
$username="socplatform-qa";
$local_path="/media/Data/Jenkins/Arjuna";
$subject = "Daily";
...
else
{
	...
	{		
		$dst_reports_dir_AON="/home/$username/share/Arjuna_Builds/Release_Builds/$buildnumber/$currentTime/AON";
		$dst_reports_dir_AON1="//192.168.42.46/share/Arjuna_Builds/Release_Builds/$buildnumber/$currentTime/AON";
	}
	elsif($subject eq "Daily")
	{
		$dst_reports_dir_AON="/home/$username/share/Arjuna_Builds/Daily_Builds/$currentDate/$currentTime/AON";
		$dst_reports_dir_AON1="//192.168.42.46/share/Arjuna_Builds/Daily_Builds/$currentDate/$currentTime/AON";
	}
...
$status=system("make clean; make BOARDTYPE=ARJUNA > BL1_buildlog.txt 2> BL1_faillog.txt");
...
else
{
	...
	if(($subject eq "Weekly") || ($subject eq "Release"))
	{
		$dst_reports_dir_BL1="/home/$username/share/Arjuna_Builds/Release_Builds/$buildnumber/$currentTime/BL1";
		$dst_reports_dir_BL11="//192.168.42.46/share/Arjuna_Builds/Release_Builds/$buildnumber/$currentTime/BL1";
	}
	elsif($subject eq "Daily")
	{
		$dst_reports_dir_BL1="/home/$username/share/Arjuna_Builds/Daily_Builds/$currentDate/$currentTime/BL1";
		$dst_reports_dir_BL11="//192.168.42.46/share/Arjuna_Builds/Daily_Builds/$currentDate/$currentTime/BL1";
	}
...
else
{
	...
	if(($subject eq "Weekly") || ($subject eq "Release"))
	{
		$dst_reports_dir_Uboot="/home/$username/share/Arjuna_Builds/Release_Builds/$buildnumber/$currentTime/U-Boot";
		$dst_reports_dir_Uboot1="//192.168.42.46/share/Arjuna_Builds/Release_Builds/$buildnumber/$currentTime/U-Boot";
	}	
	elsif($subject eq "Daily")
	{
		$dst_reports_dir_Uboot="/home/$username/share/Arjuna_Builds/Daily_Builds/$currentDate/$currentTime/U-Boot";
		$dst_reports_dir_Uboot1="//192.168.42.46/share/Arjuna_Builds/Daily_Builds/$currentDate/$currentTime/U-Boot";
	}
...
$status=system("make clean; make BOARDTYPE=ARJUNA > BL0_buildlog.txt 2> BL0_faillog.txt");
...
else
{
	...
	if(($subject eq "Weekly") || ($subject eq "Release"))
	{
		$dst_reports_dir_BL0="/home/$username/share/Arjuna_Builds/Release_Builds/$buildnumber/$currentTime/BL0";
		$dst_reports_dir_BL01="//192.168.42.46/share/Arjuna_Builds/Release_Builds/$buildnumber/$currentTime/BL0";
	}
	elsif($subject eq "Daily")
	{
		$dst_reports_dir_BL0="/home/$username/share/Arjuna_Builds/Daily_Builds/$currentDate/$currentTime/BL0";
		$dst_reports_dir_BL01="//192.168.42.46/share/Arjuna_Builds/Daily_Builds/$currentDate/$currentTime/BL0";
	}
